...
#include <algorithm> // Added for median calculation
#include "frvt1N.h"
...
namespace FRVT_1N
{
    ...
    public:
        ...
        // Method to report timing statistics
        void reportTimingStatistics() const;
    ...
    private:
        ...
        // Timing statistics
        mutable std::vector<double> createFaceTemplateTimes_;    // in milliseconds
        mutable std::vector<double> identifyTemplateTimes_;      // in milliseconds
    };
